...
contract $EtchENS is EtchENS {
    bytes32 public constant __hh_exposed_bytecode_marker = "hardhat-exposed";

    constructor(address organisationContract) EtchENS(organisationContract) payable {
    }
    ...
    function $checkENSValidity(string calldata str) external pure returns (bool ret0) {
        (ret0) = super.checkENSValidity(str);
    }
