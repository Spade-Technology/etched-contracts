...
contract $Etches is Etches {
    bytes32 public constant __hh_exposed_bytecode_marker = "hardhat-exposed";

    constructor(address teamsContract) Etches(teamsContract) payable {
    }
    ...
    function $_checkPermssion(address account,uint256 tokenId,ITeams.EPermissions permission) external view returns (bool ret0) {
        (ret0) = super._checkPermssion(account,tokenId,permission);
    }
