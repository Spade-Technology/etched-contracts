...
contract $Teams is Teams {
    bytes32 public constant __hh_exposed_bytecode_marker = "hardhat-exposed";

    constructor(address organisationsContract) Teams(organisationsContract) payable {
    }
    ...
    function $_ownerOf(uint256 teamId) external view returns (address ret0) {
        (ret0) = super._ownerOf(teamId);
    }
