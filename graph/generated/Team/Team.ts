...
export class TransferToOrganisation extends ethereum.Event {
  get params(): TransferToOrganisation__Params {
    return new TransferToOrganisation__Params(this);
  }
}

export class TransferToOrganisation__Params {
  _event: TransferToOrganisation;

  constructor(event: TransferToOrganisation) {
    this._event = event;
  }
