...
import { EntityUserPermission } from '../generated/schema';

export const upsertEntityUserPermission = (dbPermissionId: string, dbEntity: string, wallet: Bytes, permissionLevel: i32): EntityUserPermission => {
  ...
  entityPermission._entity = dbEntity;
  entityPermission._user = wallet;
  entityPermission._permissions = permissionLevel;
