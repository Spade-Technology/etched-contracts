...
import { handleApproval } from '../src-old/contract';
...
describe('Describe entity assertions', () => {
  ...
  test('Approval created and stored', () => {
    ...
    assert.fieldEquals('Approval', '0xa16081f360e3847006db660bae1c6d1b2e17ec2a-1', 'owner', '0x0000000000000000000000000000000000000001');
    assert.fieldEquals('Approval', '0xa16081f360e3847006db660bae1c6d1b2e17ec2a-1', 'approved', '0x0000000000000000000000000000000000000001');
