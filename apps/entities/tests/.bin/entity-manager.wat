(module
  ...
  (func $~lib/@graphprotocol/graph-ts/common/value/Value#displayData (type 0) (param i32) (result i32)
    ...
    i32.const 3136
    call $~lib/util/string/joinStringArray)
  (func $src/entity-manager/handleApproval (type 8) (param i32)
  ...
  (func $start:tests/entity-manager.test~anonymous|0~anonymous|0 (type 3)
    ...
    call $~lib/array/Array<~lib/@graphprotocol/graph-ts/chain/ethereum/ethereum.EventParam>#push
    local.get 3
    call $src/entity-manager/handleApproval)
  (func $start:tests/entity-manager.test~anonymous|0~anonymous|1 (type 3)
  ...
  (func $start:tests/entity-manager.test~anonymous|0~anonymous|2 (type 3)
    (local i32)
    i32.const 6912
    ...
    i32.const 7472
    call $~lib/matchstick-as/assembly/assert/assert.fieldEquals)
  (func $start:tests/entity-manager.test~anonymous|0 (type 3)
    i32.const 6960
    i32.load
    i32.const 6992
  ...
  (elem $0 (i32.const 1) func $~lib/@graphprotocol/graph-ts/common/value/Value#displayData~anonymous|0 $start:tests/entity-manager.test~anonymous|0~anonymous|0 $start:tests/entity-manager.test~anonymous|0~anonymous|1 $start:tests/entity-manager.test~anonymous|0~anonymous|2 $start:tests/entity-manager.test~anonymous|0)
