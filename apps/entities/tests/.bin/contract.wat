(module
  ...
  (import "env" "abort" (func $~lib/builtins/abort (type 2)))
  ...
  (func $~lib/@graphprotocol/graph-ts/common/datasource/DataSourceContext#constructor (type 1)
    (local i32 i32 i32)
  ...
  (func $~start (type 1)
    ...
    call $~lib/rt/stub/__alloc
    drop
    call $~lib/@graphprotocol/graph-ts/common/datasource/DataSourceContext#constructor
    i32.const 1824
  ...
  (data (;44;) (i32.const 2332) "<")
  (data (;45;) (i32.const 2348) " \00\00\00\a0\04\00\00\c0\04\00\00\e0\04\00\00\10\05\00\000\05\00\00P\05\00\00p\05\00\00\90\05")
  (data (;46;) (i32.const 2396) ",")
  (data (;47;) (i32.const 2408) "\03\00\00\00\10\00\00\000\09\00\000\09\00\00 \00\00\00\08"))
