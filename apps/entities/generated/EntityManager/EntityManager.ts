...
export class EntityManager__commentsOfResult {
  value0: string;
  value1: BigInt;
...
export class EntityManager__entitiesResult {
  value0: string;
  value1: BigInt;
  value2: BigInt;
  value3: i32;
  value4: i32;
  value5: EntityManager__entitiesResultShareMetaStruct;
  value6: EntityManager__entitiesResultFileMetaStruct;
...
export class EntityManager__metadataOfResult {
  value0: Address;
  value1: string;
  value2: string;
  value3: string;
...
export class EntityManager extends ethereum.SmartContract {
  ...
  checkSignature (
    ...
    return changetype<EntityManager__checkSignatureResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_checkSignature (
    ...
    return ethereum.CallResult.fromValue(
      changetype<EntityManager__checkSignatureResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
  ...
  commentsOf (entity: BigInt, param1: BigInt): EntityManager__commentsOfResult {
    let result = super.call(
      ...
      [
        ethereum.Value.fromUnsignedBigInt(entity),
        ethereum.Value.fromUnsignedBigInt(param1)
      ]
    );

    return new EntityManager__commentsOfResult(
      result[0].toString(),
      result[1].toBigInt()
    );
  }
  ...
  try_commentsOf (
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new EntityManager__commentsOfResult(
        value[0].toString(),
        value[1].toBigInt()
      )
    );
  ...
  entities (entity: BigInt): EntityManager__entitiesResult {
    ...
    return new EntityManager__entitiesResult(
      result[0].toString(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toI32(),
      result[4].toI32(),
      changetype<EntityManager__entitiesResultShareMetaStruct>(
        result[5].toTuple()
      ),
      changetype<EntityManager__entitiesResultFileMetaStruct>(
        result[6].toTuple()
      )
    );
  }
  ...
  try_entities (
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new EntityManager__entitiesResult(
        value[0].toString(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toI32(),
  ...
  metadataOf (entity: BigInt): EntityManager__metadataOfResult {
    ...
    return new EntityManager__metadataOfResult(
      result[0].toAddress(),
      result[1].toString(),
      result[2].toString(),
      result[3].toString(),
  ...
  try_metadataOf (
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new EntityManager__metadataOfResult(
        value[0].toAddress(),
        value[1].toString(),
        value[2].toString(),
        value[3].toString(),
  ...
  walkUpPermissionsUint (_entityId: BigInt, _user: Address, _tPerms: i32): i32 {
    let result = super.call(
      ...
      [
        ethereum.Value.fromUnsignedBigInt(_entityId),
        ethereum.Value.fromAddress(_user),
        ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(_tPerms))
      ]
    );
