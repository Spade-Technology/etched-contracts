...
export const Email = () => {
  ...
  const emails = [
    { title: "Primary Email Address", value: primaryEmail?.emailAddress || "", id: primaryEmail?.id, show: true },
    {
      ...
      show: primaryEmail?.verification?.strategy === "email_code",
    },
  ];
  ...
  return (
    <main>
      ...
      {primaryEmail?.verification?.strategy === "email_code" && (
        <div
