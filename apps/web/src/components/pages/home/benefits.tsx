    ...
    <div className="pt-16 text-center md:pt-28 ">
      ...
      <div className="flex flex-col  gap-5 py-5 text-left md:flex-row md:justify-evenly">
        ...
        <div className="mx-auto max-w-[273px] ">
          ...
          <div className="py-6 text-2xl font-semibold text-center md:text-left">Privacy on your terms</div>
        ...
        <div className="mx-auto max-w-[273px]">
          <div className="rounded-2xl bg-[#F0F9FF] px-14 py-4">
            <div className="font-bold text-[#0369A1] text-center">Etch Library</div>
            <Image src={Library_SS} alt="File_SS" width={162} height={111} className="mx-auto pt-5" />
          </div>

          <div className="py-6 text-2xl font-semibold text-center md:text-left">Etch Library</div>
        ...
        <div className="mx-auto max-w-[273px]">
          ...
          <div className="py-6 text-2xl font-semibold text-center md:text-left">Manage from one screen</div>
        ...
        <div className="mx-auto max-w-[273px]">
          ...
          <div className="py-6 text-2xl font-semibold text-center md:text-left">User friendly UI</div>
        ...
        <div className="relative flex flex-col justify-between md:flex-row">
          <div className=" max-w-[600px] px-10 text-left text-xl font-medium text-white">
            ...
            <div
              ...
              className="my-10 md:my-20 flex w-fit cursor-pointer gap-3 rounded-[60px] bg-white px-10 py-5 text-base font-semibold text-black"
            >
              Join Waitlist
