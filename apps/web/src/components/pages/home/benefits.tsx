...
const Benefits = ({ setShowWaitlist }: Props) => {
  ...
  return (
    <div className="mx-auto w-full max-w-[1566px] pt-[76px] text-center md:pt-28 xl:pt-40 ">
      ...
      <div className="relative z-10 flex grid-cols-12 flex-col gap-[46px] pt-10 text-left  min-[360px]:px-[42px] sm:grid">
        {benefits.map(({ title, text, description, img }, index) => {
          return (
            <div className="sm:col-span-6 lg:col-span-3">
              <div
                className={
                  `rounded-2xl px-14 py-4 ` +
                  `${index === 0 ? "bg-[#FFF8E5]" : index === 1 ? "bg-[#F0F9FF]" : index === 2 ? "bg-[#EEF2FF]" : "bg-[#ECFDF5]"}`
                }
              >
                <div
        ...
        <div className="absolute right-[-306px] top-16 -z-10 hidden h-[946px] w-[946px] bg-[url(/images/home/blur.svg)] bg-contain bg-center bg-no-repeat md:block"></div>
      </div>
      {/* bg-gradient-to-r from-green-400 to-cyan-500 */}
      <div
        className={`relative z-10 mx-auto mt-40 flex h-[539px] max-w-[1238px] flex-col gap-7 overflow-hidden rounded-[32px] bg-gradient-to-r from-green-400 to-cyan-500 p-10 md:h-[438px] md:pb-[95px] md:pl-[45px]`}
      >
        ...
        <div
          ...
          className="flex w-fit cursor-pointer items-center gap-[21px] rounded-[52.293px] bg-white px-[39px] py-[19px] font-body  font-semibold text-black shadow-[0px_2.80141px_11.20565px_0px_rgba(20,20,43,0.10)]"
        >
          Join Waitlist
          <Image src={BlackForward} alt="forward" className="h-[9px] w-[10.432px] " />
        </div>
        <Image
          src={Library_SS}
          alt="File_SS"
