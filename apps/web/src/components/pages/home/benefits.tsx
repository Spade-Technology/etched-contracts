      ...
      <div className="flex flex-col  gap-5 py-5 text-left md:flex-row md:justify-evenly">
        <div className="max-w-[273px] mx-auto">
          ...
          <div className="text-lg font-normal">
            Etched's intuitive and user-friendly interface ensures a smooth experience for creators of all levels, without
        ...
        <div className="max-w-[273px] mx-auto">
          ...
          <div className="text-lg font-normal">
            Etched empowers you to effortlessly manage your organisation's intellectual property. From overseeing users and
