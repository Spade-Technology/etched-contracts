...
const Slider = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SliderPrimitive.Root> & { trackerClassName?: string }
>(({ className, trackerClassName, ...props }, ref) => (
  ...
  >
    <SliderPrimitive.Track
      className={cn("bg-primary/20 relative h-1.5 w-full grow overflow-hidden rounded-full", trackerClassName)}
    >
