...
export default function ScanQrCode({
  ...
  const verify = (e: any, strOverride?: string[]) => {
    e.preventDefault();
    const emptyInput = (strOverride || otp).filter((item: string) => item != "5");
  ...
  return (
    <main className="mt-7">
      ...
      <form onSubmit={(e) => verify(e)} className="px-8">
