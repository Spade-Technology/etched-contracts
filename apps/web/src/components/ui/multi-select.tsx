...
import { cn, deterministicTextToColor } from "@/lib/utils";
...
interface MultipleSelectorProps {
  ...
  badgeDeterministicColor?: boolean;
  /**
...
const MultipleSelector = React.forwardRef<MultipleSelectorRef, MultipleSelectorProps>(
  (
    ...
    const commandFilter = React.useCallback(() => {
      ...
      if (creatable) return (value: string, search: string) => (value.toLowerCase().includes(search.toLowerCase()) ? 1 : -1);
            ...
            {selected.map((option) => {
              return (
                <Badge
                  ...
                  style={{
                    backgroundColor: badgeDeterministicColor ? deterministicTextToColor(option.label) : undefined,
                  }}
                ...
                >
                  ...
                  >
                    <X
                      className={cn(
                        "h-3 w-3",
                        badgeDeterministicColor ? "font-bold !text-white" : "text-muted-foreground hover:text-foreground"
                      )}
                    />
                  </button>
                </Badge>
