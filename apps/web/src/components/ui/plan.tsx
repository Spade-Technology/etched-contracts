          ...
          <main className="mt-6 grid grid-cols-12 gap-5">
            {plans.map(
              ({
                ...
                <article key={title} className={`col-span-4 rounded-md border p-3 shadow duration-300`}>
                  ...
                  {price ? (
                    ...
                    <>
                      <div className="mt-6 pb-3 text-4xl font-semibold text-foreground/80">Let’s talk!</div>
                      <div className=" my-4 flex w-full cursor-pointer items-center justify-center rounded border-2 border-primary bg-white py-1 text-sm font-semibold text-primary hover:shadow">
                        Contact Us
                      </div>
                    </>
                  )}
...
const plans = [
  ...
  },
  {
    price: "$250/m",
    title: "Creative Pro",
    subtitle: "Suitable for 2-5 person organizations, studios and groups.",
    period: "Billed annually",
    features: [
      "3 Creative accounts",
      "Unlimited Etches",
