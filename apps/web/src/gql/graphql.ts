...
export type EtchCommentsQuery = {
  __typename?: "Query";
  etchCommentAddeds: Array<{
    __typename?: "EtchCommentAdded";
    commentId: any;
    comment_commentIpfsCid: string;
    blockTimestamp: any;
    owner: { __typename?: "Wallet"; id: any; etchENS: Array<{ __typename?: "EtchENS"; name: string }> };
  }>;
};
...
export type EtchFragmentFragment = {
  ...
  tagLinks?: Array<{ __typename?: "TagLink"; tag?: { __typename?: "Tag"; id: string; label: string } | null }> | null;
  ownership: {
    __typename?: "EtchOwnership";
    id: string;
    owner?: { __typename?: "Wallet"; id: any; etchENS: Array<{ __typename?: "EtchENS"; id: string; name: string }> } | null;
          ...
          etch: {
            ...
            ownership: {
              ...
              owner?: {
                __typename?: "Wallet";
                id: any;
                etchENS: Array<{ __typename?: "EtchENS"; id: string; name: string }>;
              } | null;
              team?: { __typename?: "Team"; id: string; teamId: any; name?: string | null } | null;
            };
          };
...
export type GetTagsOfEtchAndOwnerQuery = {
  __typename?: "Query";
  etch?: {
    __typename?: "Etch";
    id: string;
    tagLinks?: Array<{
      __typename?: "TagLink";
      tag?: { __typename?: "Tag"; id: string; owner: { __typename?: "Wallet"; eoa: string } } | null;
    }> | null;
  } | null;
};
...
export type GetTagsOfOwnerQuery = {
  __typename?: "Query";
  tagLinks: Array<{
    __typename?: "TagLink";
    tag?: { __typename?: "Tag"; label: string; id: string; owner: { __typename?: "Wallet"; eoa: string } } | null;
  }>;
};
...
export type FullEtchCreatedFragmentFragment = {
  __typename?: "EtchCreated";
  id: any;
  to: any;
  tokenId: any;
...
export type FullEtchFragmentFragment = {
  ...
  tagLinks?: Array<{
    __typename?: "TagLink";
    tag?: { __typename?: "Tag"; id: string; label: string; owner: { __typename?: "Wallet"; eoa: string } } | null;
  }> | null;
  permissions?: Array<{
    __typename?: "EtchPermission";
    id: string;
  ...
  comments?: Array<{
    ...
    owner: { __typename?: "Wallet"; id: any; etchENS: Array<{ __typename?: "EtchENS"; id: string; name: string }> };
  }> | null;
...
export const FullEtchCreatedFragmentFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "FullEtchCreatedFragment" },
      typeCondition: { kind: "NamedType", name: { kind: "Name", value: "EtchCreated" } },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          { kind: "Field", name: { kind: "Name", value: "id" } },
...
} as unknown as DocumentNode<FullEtchCreatedFragmentFragment, unknown>;
              ...
              selections: [
                ...
                },
                {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      { kind: "Field", name: { kind: "Name", value: "id" } },
                      { kind: "Field", name: { kind: "Name", value: "eoa" } },
                      {
                        kind: "Field",
                        name: { kind: "Name", value: "etchENS" },
                        selectionSet: {
                  ...
                  selectionSet: {
                    ...
                    selections: [
                      ...
                      { kind: "Field", name: { kind: "Name", value: "label" } },
                      {
                        ...
                        selectionSet: {
                          kind: "SelectionSet",
                          selections: [{ kind: "Field", name: { kind: "Name", value: "eoa" } }],
                        },
                      },
                    ],
                  },
...
export const EtchCommentsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "EtchComments" },
      variableDefinitions: [
        {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: "Field",
            name: { kind: "Name", value: "etchCommentAddeds" },
            arguments: [
...
} as unknown as DocumentNode<EtchCommentsQuery, EtchCommentsQueryVariables>;
          ...
          },
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: "Field",
                  name: { kind: "Name", value: "externalEtches" },
                  selectionSet: {
                    kind: "SelectionSet",
                    selections: [
                      {
...
export const GetTagsOfEtchAndOwnerDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetTagsOfEtchAndOwner" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
...
} as unknown as DocumentNode<GetTagsOfEtchAndOwnerQuery, GetTagsOfEtchAndOwnerQueryVariables>;
export const GetTagsOfOwnerDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetTagsOfOwner" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "owner" } },
...
} as unknown as DocumentNode<GetTagsOfOwnerQuery, GetTagsOfOwnerQueryVariables>;
  ...
  definitions: [
    {
      ...
      selectionSet: {
        ...
        selections: [
          ...
          {
            kind: "Field",
            name: { kind: "Name", value: "etchCreateds" },
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "where" },
            ...
            selectionSet: {
              kind: "SelectionSet",
              selections: [{ kind: "FragmentSpread", name: { kind: "Name", value: "FullEtchCreatedFragment" } }],
            },
          },
        ],
      },
                        ...
                        values: [
                          ...
                          },
                          {
                            ...
                            fields: [
                              {
                                kind: "ObjectField",
                                name: { kind: "Name", value: "eoa_contains_nocase" },
                                value: { kind: "Variable", name: { kind: "Name", value: "input" } },
                              },
                            ],
                          },
