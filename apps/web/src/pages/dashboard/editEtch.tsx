...
import EtchSection from "@/components/pages/editEtch/etchSection";
...
export default function EditEtch() {
  ...
  return (
    <PageBoilerplate>
          <div className="py-6 my-4 items-center px-6 shadow-etched-1">
        <div>Client 2 Etch Folder {'>'} Blueprints {'>'} Chip designs {'>'} S2 Chip {'>'} Etch file name</div>
