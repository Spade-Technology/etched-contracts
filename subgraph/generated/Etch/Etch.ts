...
export class CommentAdded__Params {
  ...
  get comment(): CommentAddedCommentStruct {
    return changetype<CommentAddedCommentStruct>(
      this._event.parameters[2].value.toTuple()
    );
  }
}

export class CommentAddedCommentStruct extends ethereum.Tuple {
...
export class EtchTransferedToTeam extends ethereum.Event {
  get params(): EtchTransferedToTeam__Params {
    return new EtchTransferedToTeam__Params(this);
  }
}

export class EtchTransferedToTeam__Params {
  _event: EtchTransferedToTeam;

  constructor(event: EtchTransferedToTeam) {
    this._event = event;
  }
...
export class InvididualPermissionsUpdated extends ethereum.Event {
  get params(): InvididualPermissionsUpdated__Params {
    return new InvididualPermissionsUpdated__Params(this);
  }
}

export class InvididualPermissionsUpdated__Params {
  _event: InvididualPermissionsUpdated;

  constructor(event: InvididualPermissionsUpdated) {
    this._event = event;
  }
